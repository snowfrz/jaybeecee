...
const string strMessageMagic = "Jaybeecee Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Jaybeecee: 1 day
static const int64 nTargetSpacing = 10; // Jaybeecee: 10 second block
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal jaybeecee miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Jaybeecee", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x83174e253dfcc3bc0337e8eec24aec39a31515b7b0f478c5fc6bdf9fd3b9eb33");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "April 12, 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 387938648;

        if (fTestNet)
        {
            block.nTime    = 1429831446;
        ...
        assert(block.hashMerkleRoot == uint256("327c09864802faf8f1eca1e8f0007933b653f2c40e0a5dcd271ffbbe8d3f996c"));
